...
const eventHandler = useEventHandler('EnhancedComponent')
...
const handleRetry = () => {
  if (props.retryAction) {
    eventHandler.handleAsyncEvent(props.retryAction, {
      actionName: 'retry_action',
      successMessage: 'Action completed successfully',
      errorMessage: 'Retry failed'
    })
  }
  emit('retry-clicked')
  componentLogger.debug('Retry action triggered')
}
